...
@section('head-content')
    <a class="btn btn-outline-success" href="{{ route('laboratory.edit',['laboratory'=>$laboratory->id]) }}" >
        ویرایش قسمت  {{$laboratory->name}}
    </a>
@endsection
...
@section('content')
    ...
    <div class="row">
        @foreach($images as $key=>$value)
            <div class="col text-center">
                <img style=" max-width: 100%;height: auto;" src="<?= url('images/laboratory_'.$value) ?>" >
            </div>
        @endforeach
    </div>
    <div class="row">
